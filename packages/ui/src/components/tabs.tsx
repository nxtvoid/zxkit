  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-[state="active"]:bg-background dark:data-[state="active"]:text-foreground dark:data-[state="active"]:border-primary-foreground/80 dark:data-[state="active"]:bg-primary-foreground data-[state="active"]:text-foreground',
